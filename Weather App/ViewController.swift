...
class ViewController: UIViewController {
    ...
    private lazy var dailyForecastTableView: UITableView = {
        ...
        tableView.separatorColor = UIColor.contrast
        return tableView
    }()
    
    private let service = Service()
    private var city = City(lat: "-19.912998", lon: "-43.940933", name: "Belo Horizonte")
    ...
    private func setConstraints(){
        ...
        NSLayoutConstraint.activate([
            ...
            dailyForecastLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 25),
            dailyForecastLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -25),
